...
#ifndef CPP_ACTORS_SUBSCRIBER2_H
#define CPP_ACTORS_SUBSCRIBER2_H
#include <chrono>
#include <thread>
#include "Messages.h"
#include "Actor.h"
...
#define SUBSCRIBER2() std::shared_ptr<Actors::Actor>(new Actors::Subscriber2())
...
#endif //CPP_ACTORS_SUBSCRIBER2_H
