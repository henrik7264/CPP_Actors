...
#ifndef CPP_ACTORS_SUBSCRIBER8_H
#define CPP_ACTORS_SUBSCRIBER8_H
#include <chrono>
#include <thread>
#include "Messages.h"
#include "Actor.h"
...
#define SUBSCRIBER8() std::shared_ptr<Actors::Actor>(new Actors::Subscriber8())
...
#endif //CPP_ACTORS_SUBSCRIBER8_H
