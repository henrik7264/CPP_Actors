...
#ifndef CPP_ACTORS_SUBSCRIBER1_H
#define CPP_ACTORS_SUBSCRIBER1_H
#include <chrono>
#include <thread>
#include "Messages.h"
#include "Actor.h"
...
#define SUBSCRIBER1() std::shared_ptr<Actors::Actor>(new Actors::Subscriber1())
...
#endif //CPP_ACTORS_SUBSCRIBER1_H
