...
#ifndef CPP_ACTORS_SUBSCRIBER7_H
#define CPP_ACTORS_SUBSCRIBER7_H
#include <chrono>
#include <thread>
#include "Messages.h"
#include "Actor.h"
...
#define SUBSCRIBER7() std::shared_ptr<Actors::Actor>(new Actors::Subscriber7())
...
#endif //CPP_ACTORS_SUBSCRIBER7_H
