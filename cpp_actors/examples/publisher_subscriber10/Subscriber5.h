...
#ifndef CPP_ACTORS_SUBSCRIBER5_H
#define CPP_ACTORS_SUBSCRIBER5_H
#include <chrono>
#include <thread>
#include "Messages.h"
#include "Actor.h"
...
#define SUBSCRIBER5() std::shared_ptr<Actors::Actor>(new Actors::Subscriber5())
...
#endif //CPP_ACTORS_SUBSCRIBER5_H
